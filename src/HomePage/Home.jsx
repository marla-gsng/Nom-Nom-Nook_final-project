...
function Home() {
  ...
  const trendingRecipes = [
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/8642fa64f268f15b5bc7aa3ccaa3e48d65653b35e18ff72884d48d8177343e77?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Spicy Shrimp Ramen",
      duration: "30 minutes",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/1022cef90e997b1d321e8d6bbee54f188f0821ac8e34ca33b168c461553341f6?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Sweet Potato Fries",
      duration: "40 minutes",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/66e17fcc91ba29731ab2dd57009949aee3bc421d8a188602b3240295eea547a7?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Butter Chicken",
      duration: "1 hour",
    },
  ];

  const mostLovedRecipes = [
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/85410d23a0be9a3332c2a160c806131bad6354fbf2718430c4487ab89f5048bb?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Chocolate Chip Cookies",
      duration: "35 minutes",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/61f8e95e9808ebd90e468a461034af37313f83f13295febabd052d6bcee611ff?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Pizza Dough",
      duration: "5 minutes",
    },
    {
      image:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/30f64d18905fa0e15400c974fbe0b46a316329db09bfa26a490a21a6af9a2f69?apiKey=23ef07f824434f9a8236d755b15aa490&",
      title: "Brownies",
      duration: "25 minutes",
    },
  ];
      ...
      <div className="flex flex-col justify-center bg-white">
        <div className="flex flex-col items-center w-full bg-white max-md:max-w-full">
          ...
          <div className="flex flex-col p-4 mt-5 w-full max-w-[960px] max-md:max-w-full">
            ...
            <RecipeSection title="Most Loved" recipes={mostLovedRecipes} />
          </div>
          <Footer />
        </div>
      </div>
